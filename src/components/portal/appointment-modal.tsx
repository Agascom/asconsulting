...
export function AppointmentModal({ isOpen, onClose }: AppointmentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-slate-950/80 p-4 backdrop-blur-sm animate-fade-in sm:items-center">
